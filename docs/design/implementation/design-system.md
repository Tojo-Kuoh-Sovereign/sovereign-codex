...
The Design System exists to ensure every interface element expresses the same visual language while remaining scalable, maintainable, and consistent.
...
The Design System should evolve through deliberate refinement.

Changes should strengthen consistency, maintainability, accessibility, and long-term scalability while remaining faithful to the Design Philosophy.